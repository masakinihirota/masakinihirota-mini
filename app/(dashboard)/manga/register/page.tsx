...
import { BookOpen, User, FileText, CheckCircle, AlertCircle } from "lucide-react"
    ...
    <div className="container mx-auto py-10 px-4 max-w-3xl">
      <Card className="border-2 shadow-lg">
        <CardHeader className="space-y-1 bg-muted/50">
          <CardTitle className="text-2xl font-bold text-center">Register a Manga Work</CardTitle>
          <CardDescription className="text-center">Add a new manga to the collection</CardDescription>
        </CardHeader>
